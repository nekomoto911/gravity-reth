...
use crate::{
    ...
    TransactionVariant, TransactionsProvider, WithdrawalsProvider, StateProviderOptions
};
...
impl<C: Send + Sync + 'static, N: NodePrimitives> StateProviderFactory for NoopProvider<C, N> {
    ...
    fn latest_with_opts(&self, opts: crate::StateProviderOptions) -> ProviderResult<StateProviderBox> {
        todo!()
    }
}
